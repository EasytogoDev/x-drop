        ...
        <FiltersContainer>
          <div>
            ...
            <Select value={tipoRelatorio} onChange={(e) => setTipoRelatorio(e.target.value)}>
              ...
              <option value="Notas de Entrada">Notas de Entrada</option>
              <option value="Ordens da compra">Ordens da compra</option>
              <option value="Entrada de Produtos">Entrada de Produtos</option>
              <option value="Consistência nos valores de compra">Consistência nos valores de compra</option>
            </Select>
          </div>
          ...
          {/* Campos para "Consistência nos valores de compra" */}
          {tipoRelatorio === 'Consistência nos valores de compra' && (
            <>
              <div>
                <Label>Empresa</Label>
                <Input
